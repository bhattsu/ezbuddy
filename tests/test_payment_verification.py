...
@pytest.mark.asyncio
async def test_court_payment_stores_account_and_moves_to_braintree_cards():
    ...
    session.selections = {
        ...
        "court_payment_accounts": [{"id": "acct-1", "name": "Primary", "label": "Primary"}],
    }
    ...
    assert session.selections["court_payment_account_id"] == "acct-1"
